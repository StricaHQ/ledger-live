...
export const cryptocurrenciesById: Record<CryptoCurrencyId, CryptoCurrency> = {
  ...
  mantle: {
    ...
    color: "#0E121B",
    family: "evm",
    units: ethereumUnits("MNT", "MNT"),
    ethereumLikeInfo: {
      chainId: 5000,
    },
    explorerViews: [blockscoutExplorerView("https://explorer.mantle.xyz")],
    keywords: ["mantle"],
  },
  mantle_sepolia: {
    type: "CryptoCurrency",
    ...
    explorerViews: [blockscoutExplorerView("https://explorer.sepolia.mantle.xyz")],
  },
  klaytn: {
    type: "CryptoCurrency",
    id: "klaytn",
